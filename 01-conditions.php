...
?>
<h2>Condition ternaire: on peut faire ce que fait un if / else en une ligne seulement</h2>
<?php
//Faites une ternaire sur hasard avec les résultats de l'exemple précédent mise dans une variable, la condition est que $hasard est ou plus petit que 5 ou plus grand que 5 ou égal à 5

$ternaire = $hasard < 5 ? '$hasard vaut '."$hasard et est donc plus petit que 5" : '$hasard vaut '."$hasard et est donc plus grand que 5";
echo $ternaire;
?>
